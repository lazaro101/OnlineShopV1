...
<div class="content">
	...
	<ul class="nav nav-tabs">
  		...
  		<li role="presentation" class="active"><a href="ordersListCancel.php">Cancelled</a></li>
	</ul><br>
		...
		<thead>
			...
			<?php
				$sql = "SELECT orders.orderID, orders.orderDate, orders.status, orders.subTotal, client.firstName, client.lastName 
						FROM orders 
						INNER JOIN client 
						ON orders.username = client.email AND orders.deleted = '0' AND orders.checkout = '1' AND orders.status = '2'
			...
			<tr onclick="window.document.location.href='editOrdersList.php?varname=<?php echo $row["orderID"]; ?> ';" style="cursor: pointer;">
				...
				<td class="sta"><span class="bg-danger stat">Cancelled</span></td>
