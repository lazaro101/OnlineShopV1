		...
		<form class="form-horizontal" method="POST" action="addupdatedelete.php" name="form">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-6" id="fname">
		      		<input type="text" class="form-control" placeholder="First Name" name="fname" value="<?php echo $row['addFirstName'] ?>" onfocus="removeError(this.name)">
		    	</div>
		  	</div>
			<div class="col-sm-offset-4 col-sm-6" id="errFname">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-6" id="lname">
		      		<input type="text" class="form-control" placeholder="Last Name" name="lname" value="<?php echo $row['addLastName'] ?>" onfocus="removeError(this.name)">
		    	</div>
		  	</div>
			<div class="col-sm-offset-4 col-sm-6" id="errLname">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-6" id="number">
		      		<input type="number" class="form-control" placeholder="Number" name="number" value="<?php echo $row['phone'] ?>" onfocus="removeError(this.name)">
		    	</div>
		  	</div>
			<div class="col-sm-offset-4 col-sm-6" id="errNum">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-6" id="prov">
		      		<input type="text" class="form-control" placeholder="Province" name="prov" value="<?php echo $row['province'] ?>" onfocus="removeError(this.name)">
		    	</div>
		  	</div>
			<div class="col-sm-offset-4 col-sm-6" id="errProv">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-6" id="city">
		      		<input type="text" class="form-control" placeholder="City" name="city" value="<?php echo $row['city'] ?>" onfocus="removeError(this.name)">
		    	</div>
		  	</div>
			<div class="col-sm-offset-4 col-sm-6" id="errCity">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-6" id="brgy">
		      		<input type="text" class="form-control" placeholder="Barangay" name="brgy" value="<?php echo $row['brgy'] ?>" onfocus="removeError(this.name)">
		    	</div>
		  	</div>
			<div class="col-sm-offset-4 col-sm-6" id="errBrgy">
		  	...
		  	<div class="form-group">
			    ...
			    <div class="col-sm-6" id="compadd">
			    	<textarea class="form-control" name="compadd" onfocus="removeError(this.name)"><?php echo $row['completeAdd'] ?></textarea>
		    	</div>
		  	</div>
			...
			<div class="col-sm-offset-4 col-sm-6" id="errAll">
		  	...
		  	<div class="col-md-offset-4 col-md-4">
			  	<button type="submit" name="saveEditAdd" class="btn btn-default" onclick="return validate()">Submit</button>
		  	</div>
		</form>
	</div>
</div>
